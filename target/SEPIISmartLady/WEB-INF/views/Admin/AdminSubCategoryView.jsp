                    ...
                    <div class="content-body">    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <body ng-app="myApp" class="ng-cloak">
                                <div class="generic-container" ng-controller="SubCategoryController as ctrl">
                                    <div class="panel panel-default">
                                        <div class="panel-heading"><span class="lead">SubCategory Management</span></div>
                                        <div class="formcontainer">
                                            <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                                                <input type="hidden" ng-model="ctrl.subcategory.id" />
                                                <div class="row">
                                                    <div class="form-group col-md-12">
                                                        <label class="col-md-2 control-lable" for="file">ID</label>
                                                        <div class="col-md-7">
                                                            <input type="text" ng-model="ctrl.subcategory.id" name="id" class="id form-control input-sm" ng-minlength="1" disabled/>
                                                            <div class="has-error" ng-show="myForm.$dirty">
                                                                <span ng-show="myForm.catID.$error.required">This is a required field</span>
                                                                <span ng-show="myForm.catID.$error.minlength">Minimum length required is 3</span>
                                                                <span ng-show="myForm.catID.$invalid">This field is invalid </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-12">
                                                        <label class="col-md-2 control-lable" for="file">CatID</label>
                                                        <div class="col-md-7">
                                                            <input type="text" ng-model="ctrl.subcategory.catID" class="form-control input-sm" placeholder="Enter your Cat ID. [This field is validation free]"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <div class="col-md-7">
                                                            <input type="text" ng-model="ctrl.subcategory.subCatName" class="form-control input-sm" placeholder="Enter your Subcategory Name. [This field is validation free]"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <div class="col-md-7">
                                                            <input type="text" ng-model="ctrl.subcategory.subCatDescription" name="subCatDescription" class="subCatDescription form-control input-sm" placeholder="Enter your Subcategory Description" required/>
                                                            <div class="has-error" ng-show="myForm.$dirty">
                                                                <span ng-show="myForm.subCatDescription.$error.required">This is a required field</span>
                                                            </div>
                                                        </div>
                                                        <div class="form-actions floatRight">
                                                            <input type="submit"  value="{{!ctrl.subcategory.id ? 'Add' : 'Update'}}" class="btn btn-primary btn-sm" ng-disabled="myForm.$invalid">
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-heading"><span class="lead">List of Sub-Categories </span></div>
                                        <div class="tablecontainer">
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                <tr ng-repeat="u in ctrl.subcategories">
                                                    <td><span ng-bind="u.id"></span></td>
                                                    <td><span ng-bind="u.subCatName"></span></td>
                                                    <td><span ng-bind="u.subCatDescription"></span></td>
                                                    <td><span ng-bind="u.catID"></span></td>
                                                    <td>
...
<script src="static/js/service/subcategory_service.js"></script>
<script src="static/js/controller/subcategory_controller.js"></script>
