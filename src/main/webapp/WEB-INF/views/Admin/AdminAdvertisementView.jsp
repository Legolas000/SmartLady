                    ...
                    <div class="content-body">    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <body ng-app="myApp" class="ng-cloak">
                                <div class="generic-container" ng-controller="AdvertisementController as ctrl">
                                    <div class="panel panel-default">
                                        <!-- Default panel contents -->
                                        <div class="panel-heading"><span class="lead">List of Advertisements</span></div>
                                        <div class="tablecontainer">
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                <tr ng-repeat="u in ctrl.advertisements">
                                                    <td><span ng-bind="u.id"></span></td>
                                                    <td><span ng-bind="u.url"></span></td>
                                                    <td><span ng-bind="u.description"></span></td>
                                                    <td><span ng-bind="u.publishedDate"></span></td>
                                                    <td><span ng-bind="u.expiryDate"></span></td>
                                                    <td><span ng-bind="u.payment"></span></td>
                                                    <td><span ng-bind="u.status"></span></td>
                                                    <td>
                                                        <button type="button" ng-click="ctrl.approve(u.id)" class="btn btn-success custom-width">Approve</button>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>
...
<script src="static/js/service/advertisement_service.js"></script>
<script src="static/js/controller/advertisement_controller.js"></script>
