                            ...
                            <body ng-app="myApp" class="ng-cloak">
                                <div class="generic-container" ng-controller="CategoryController as ctrl">
                                    <div class="panel panel-default">
                                        <div class="panel-heading"><span class="lead">Category Management</span></div>
                                            ...
                                            <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <div class="col-md-7">
                                                            <input type="text" ng-model="ctrl.category.id" name="id" class="id form-control input-sm" ng-minlength="1" disabled/>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <div class="col-md-7">
                                                            <input type="text" ng-model="ctrl.category.catName" class="form-control input-sm" placeholder="Enter your category Name. [This field is validation free]"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <div class="col-md-7">
                                                            <input type="text" ng-model="ctrl.category.catDescription" name="catDescription" class="catDescription form-control input-sm" placeholder="Enter your category Description" required/>
                                                            <div class="has-error" ng-show="myForm.$dirty">
                                                                <span ng-show="myForm.catDescription.$error.required">This is a required field</span>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="tablecontainer">
                                            <table class="table table-hover">
                                                ...
                                                <tr ng-repeat="u in ctrl.categories">
                                                    ...
                                                    <td><span ng-bind="u.catName"></span></td>
                                                    <td><span ng-bind="u.catDescription"></span></td>
                                                    <td>
...
<script src="static/js/service/category_service.js"></script>
<script src="static/js/controller/category_controller.js"></script>
