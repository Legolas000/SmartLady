...
<!-- Container -->
<div id="container" ng-controller="UserController as userCtrl">
					...
					<div class="row">
						<div class="col-md-9">
							<ul class="top-line-list">
								...
								<li><a href="{{userCtrl.modalPath}}" <%--class="launch-modal" data-modal-id="#modal-login"--%>
									   data-toggle="modal" data-target="#modal-login">Log In</a></li>
								<li><a href="{{userCtrl.modalPath}}" <%--class="launch-modal" data-modal-id="#modal-login"--%>
									   data-toggle="modal" data-target="#modal-register">Sign Up</a></li>
			...
			<div class="logo-advertisement">
				<div class="container">
					...
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="index.html"><img src="/static/images/logo-black.png" alt=""></a>
					</div>
													...
													<div class="owl-carousel" data-num="4">
														...
														<div class="item news-post standard-post">
															<div class="post-gallery">
																<img src="/static/upload/news-posts/art1.jpg" alt="">
															</div>
														...
														<div class="item news-post standard-post">
															<div class="post-gallery">
																<img src="/static/upload/news-posts/art2.jpg" alt="">
															</div>
															<div class="post-content">
														...
														<div class="item news-post standard-post">
															<div class="post-gallery">
																<img src="/static/upload/news-posts/art3.jpg" alt="">
															</div>
															<div class="post-content">
														...
														<div class="item news-post standard-post">
															<div class="post-gallery">
																<img src="/static/upload/news-posts/art6.jpg" alt="">
															</div>
															<div class="post-content">
														...
														<div class="item news-post standard-post">
															<div class="post-gallery">
																<img src="/static/upload/news-posts/art9.jpg" alt="">
															</div>
															<div class="post-content">
																<h2><a href="single-post.html">Donec nec justo eget felis facilisis fermentum. </a></h2>
																<ul class="post-tags">
											...
											<div class="owl-wrapper">
												...
												<div class="owl-carousel" data-num="4">
													...
													<div class="item news-post video-post">
														<img alt="" src="/static/upload/news-posts/video1.jpg">
													...
													<div class="item news-post video-post">
														<img alt="" src="/static/upload/news-posts/video2.jpg">
														<a href="https://www.youtube.com/watch?v=LL59es7iy8Q" class="video-link"><i class="fa fa-play-circle-o"></i></a>
														<div class="hover-box">
													...
													<div class="item news-post video-post">
														<img alt="" src="/static/upload/news-posts/video3.jpg">
														<a href="https://www.youtube.com/watch?v=LL59es7iy8Q" class="video-link"><i class="fa fa-play-circle-o"></i></a>
														<div class="hover-box">
													...
													<div class="item news-post video-post">
														<img alt="" src="/static/upload/news-posts/video4.jpg">
														<a href="https://www.youtube.com/watch?v=LL59es7iy8Q" class="video-link"><i class="fa fa-play-circle-o"></i></a>
														<div class="hover-box">
															<h2><a href="single-post.html">Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede.</a></h2>
															<ul class="post-tags">
		...
		<div class="container">
			...
			<div  class="iso-call heading-news-box">
					...
					<ul class="bxslider">
						<li>
							<div class="news-post image-post">
								<img src="/static/upload/news-posts/h7.jpg" alt="">
								<div class="hover-box">
									<div class="inner-hover">
										<a class="category-post sport" ng-click="userCtrl.getReaderArticle(100)">Sport 123</a>
						...
						<li>
							<div class="news-post image-post">
								...
								<div class="hover-box">
									<div class="inner-hover">
										<a class="category-post world" ng-click="userCtrl.getReaderArticle(101)">Business 123</a>
				...
				<div class="news-post image-post default-size">
					<img src="/static/upload/news-posts/h1.jpg" alt="">
					<div class="hover-box">
						<div class="inner-hover">
							<a class="category-post travel" href="travel.html">travel</a>
				...
				<div class="news-post image-post">
					<img src="/static/upload/news-posts/h3.jpg" alt="">
					<div class="hover-box">
						<div class="inner-hover">
				...
				<div class="news-post image-post">
					<img src="/static/upload/news-posts/h5.jpg" alt="">
					<div class="hover-box">
						<div class="inner-hover">
				...
				<div class="news-post image-post">
					<img src="/static/upload/news-posts/h6.jpg" alt="">
					<div class="hover-box">
						<div class="inner-hover">
	...
	<%--<div>
		<input value="Single Post" type="button" ng-click="userCtrl.getReaderArticle(101)">
	</div>--%>
